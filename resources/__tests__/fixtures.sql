...
VALUES (1001, 'Ben', 'Smith', 'ben.smith@mail.net', true, '10-02-2021', 2);
INSERT INTO users (id, first_name, last_name, email, activated, last_seen_at, instance_quota)
VALUES (1002, 'Jane', 'Murphy', 'jane.murphy@mail.net', true, '09-02-2021', 2);
INSERT INTO users (id, first_name, last_name, email, activated, last_seen_at, instance_quota)
VALUES (1003, 'John', 'Doe', 'john.doe@mail.net', true, '10-02-2021', 10);
INSERT INTO users (id, first_name, last_name, email, activated, last_seen_at, instance_quota)
VALUES (1004, 'John', 'Murlow', 'john.murlow@mail.net', true, '09-02-2021', 2);

INSERT INTO account (id, user_id, username, uid, gid, home_path)
VALUES (1, 1001, 'smith', 1001, 2002, '/home/smith');
INSERT INTO account (id, user_id, username, uid, gid, home_path)
VALUES (2, 1002, 'murphy', 1002, 2001, '/home/murphy');
INSERT INTO account (id, user_id, username, uid, gid, home_path)
VALUES (3, 1003, 'doe', 1003, 2000, '/home/doe');
INSERT INTO account (id, user_id, username, uid, gid, home_path)
VALUES (4, 1004, 'murlow', 1004, 2000, '/home/murlow');
